...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/(authenticated)" | "/" | "/(authenticated)/admin" | "/(authenticated)/admin/invite" | "/(authenticated)/admin/logs" | "/(authenticated)/admin/migrations" | "/api" | "/api/admin" | "/api/admin/invites" | "/api/admin/invite" | "/api/admin/invite/delete" | "/api/admin/logs" | "/api/admin/panels" | "/api/admin/panels/heartbeat" | "/api/admin/panels/order" | "/api/admin/panels/regenerate" | "/api/inquiries" | "/api/inquiry" | "/api/inquiry/archive" | "/api/inquiry/clear" | "/api/inquiry/delete-old" | "/api/inquiry/delete" | "/api/inquiry/reply" | "/api/inquiry/resend" | "/api/inquiry/seen" | "/api/inquiry/send-email" | "/api/me" | "/api/panels" | "/api/panels/list" | "/api/panels/upload" | "/api/panels/upload/finish" | "/api/whoami" | "/(authenticated)/archive" | "/(authenticated)/dashboard" | "/endpoints" | "/endpoints/api" | "/endpoints/api/whoami" | "/login" | "/logout" | "/panels.json" | "/register" | "/(authenticated)/settings" | "/signup" | "/(authenticated)/upload" | "/[chapter]" | "/[chapter]/[panel]";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/api/admin/panels/heartbeat": Record<string, never>;
			"/api/admin/panels/order": Record<string, never>;
			...
			"/api/panels/upload/finish": Record<string, never>;
		...
		Pathname(): "/" | "/admin" | "/admin/" | "/admin/invite" | "/admin/invite/" | "/admin/logs" | "/admin/logs/" | "/admin/migrations" | "/admin/migrations/" | "/api" | "/api/" | "/api/admin" | "/api/admin/" | "/api/admin/invites" | "/api/admin/invites/" | "/api/admin/invite" | "/api/admin/invite/" | "/api/admin/invite/delete" | "/api/admin/invite/delete/" | "/api/admin/logs" | "/api/admin/logs/" | "/api/admin/panels" | "/api/admin/panels/" | "/api/admin/panels/heartbeat" | "/api/admin/panels/heartbeat/" | "/api/admin/panels/order" | "/api/admin/panels/order/" | "/api/admin/panels/regenerate" | "/api/admin/panels/regenerate/" | "/api/inquiries" | "/api/inquiries/" | "/api/inquiry" | "/api/inquiry/" | "/api/inquiry/archive" | "/api/inquiry/archive/" | "/api/inquiry/clear" | "/api/inquiry/clear/" | "/api/inquiry/delete-old" | "/api/inquiry/delete-old/" | "/api/inquiry/delete" | "/api/inquiry/delete/" | "/api/inquiry/reply" | "/api/inquiry/reply/" | "/api/inquiry/resend" | "/api/inquiry/resend/" | "/api/inquiry/seen" | "/api/inquiry/seen/" | "/api/inquiry/send-email" | "/api/inquiry/send-email/" | "/api/me" | "/api/me/" | "/api/panels" | "/api/panels/" | "/api/panels/list" | "/api/panels/list/" | "/api/panels/upload" | "/api/panels/upload/" | "/api/panels/upload/finish" | "/api/panels/upload/finish/" | "/api/whoami" | "/api/whoami/" | "/archive" | "/archive/" | "/dashboard" | "/dashboard/" | "/endpoints" | "/endpoints/" | "/endpoints/api" | "/endpoints/api/" | "/endpoints/api/whoami" | "/endpoints/api/whoami/" | "/login" | "/login/" | "/logout" | "/logout/" | "/panels.json" | "/panels.json/" | "/register" | "/register/" | "/settings" | "/settings/" | "/signup" | "/signup/" | "/upload" | "/upload/" | `/${string}` & {} | `/${string}/` & {} | `/${string}/${string}` & {} | `/${string}/${string}/` & {};
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/favicon.png" | "/panels/_order.json" | "/panels.json" | string & {};
	}
}