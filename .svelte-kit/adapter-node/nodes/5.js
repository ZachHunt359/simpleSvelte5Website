import * as server from '../entries/pages/(authenticated)/admin/invite/_page.server.ts.js';

export const index = 5;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(authenticated)/admin/invite/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(authenticated)/admin/invite/+page.server.ts";
