...
declare module '$env/static/private' {
	...
	export const IMAP_HOST: string;
	export const IMAP_PORT: string;
	export const IMAP_USER: string;
	export const IMAP_PASS: string;
	export const IMAP_SENT_CANDIDATES: string;
	...
	export const OPERA_CRASH_EMAIL: string;
