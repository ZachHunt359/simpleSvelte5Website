...
type RouteParams = {  };
type RouteId = '/(authenticated)/archive';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(authenticated)/archive/+page.server.js').load>>>>>>;
